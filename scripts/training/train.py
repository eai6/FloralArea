...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="/Users/edwardamoah/Documents/GitHub/FloralArea/datasets/FloralArea-12/data.yaml", help="Path to dataset yaml file")
